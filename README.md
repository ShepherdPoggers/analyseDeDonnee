...
Il faut par la suite activer l'environnement avec `scienceDonneeEnv/Scripts/activate` pour windows.
...
Pour ouvrir l'application streamlit, il faut executer la commande : `streamlit run src/app.py` depuis le fichier analyseNetflix
